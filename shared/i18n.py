...
_CATALOGUE: dict[str, dict[str, str]] = {
    ...
    "crypto.label_accumulated_since": {"es": "(desde {date})",
                                        "en": "(since {date})"},
    ...
    "etf.ui.portfolio_summary_header": {"es": "Resumen portfolio",
                                        "en": "Portfolio summary"},
    "etf.ui.total_invested":      {"es": "Total invertido",
                                  "en": "Total invested"},
    "etf.ui.total_gain_loss":     {"es": "Ganancia/pérdida total",
                                  "en": "Total gain/loss"},
    "etf.ui.since":               {"es": "Desde {date}",
                                  "en": "Since {date}"},
